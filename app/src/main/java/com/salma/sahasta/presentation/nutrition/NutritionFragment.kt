...
import com.salma.sahasta.presentation.nurtritionresult.NutritionResultActivity

class NutritionFragment : Fragment() {
    private lateinit var binding: FragmentNutritionBinding
    private var imageCapture: ImageCapture? = null
//    private val cameraExecutor: ExecutorService by lazy {
//        Executors.newSingleTh4readExecutor()
//    }
    ...
    private fun setClickListener() {
        ...
        binding.btnScan.setOnClickListener {
            binding.btnScan.setOnClickListener {
                val intent = Intent(requireContext(), NutritionResultActivity::class.java)
